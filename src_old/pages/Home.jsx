        ...
        <div className="container" style={{ display: 'flex', gap: '3rem', margin: '4rem auto', flexWrap: 'wrap' }}>
          ...
          <div className="hero-content" style={{ flex: '2 1 500px' }}>
            ...
            <p style={{ color: 'var(--color-text-muted)', fontSize: '1.2rem', marginBottom: '2rem', maxWidth: '600px' }}>
              Welcome to the ultimate retro and modern gaming destination. Explore our vast collection of pinball machines and classic arcade cabinets!
            </p>
            <div style={{ display: 'flex', gap: '1rem' }}>
              <Link to="/games" className="btn-primary">View All Games</Link>
          ...
          <aside className="hours-sidebar glass-panel" style={{ flex: '1 1 300px', padding: '2rem', height: 'fit-content' }}>
             ...
             <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
               <li style={{ display: 'flex', justifyContent: 'space-between' }}>
                 ...
                 <span style={{ color: 'var(--color-secondary)', fontWeight: '600' }}>12PM - 10PM</span>
               </li>
               <li style={{ display: 'flex', justifyContent: 'space-between' }}>
                 <span>Friday</span>
                 <span style={{ color: 'var(--color-secondary)', fontWeight: '600' }}>12PM - 1AM</span>
               </li>
               <li style={{ display: 'flex', justifyContent: 'space-between' }}>
                 <span>Saturday</span>
                 <span style={{ color: 'var(--color-secondary)', fontWeight: '600' }}>10AM - 1AM</span>
               </li>
               <li style={{ display: 'flex', justifyContent: 'space-between' }}>
                 <span>Sunday</span>
                 <span style={{ color: 'var(--color-secondary)', fontWeight: '600' }}>10AM - 10PM</span>
               </li>
             </ul>
             ...
             <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
               ...
               <p style={{ color: 'var(--color-text-muted)' }}>123 Perry Street<br/>Arcade District, NY 10014</p>
             </div>
          </aside>
